...
const slidesDataContent = `export interface Slide {
  id: number;
  category: string;
  title: string;
  subtitle: string;
...
fs.writeFileSync(path.join(__dirname, '../src/app/presentation/slidesData.ts'), slidesDataContent, 'utf8');
console.log('Successfully wrote slidesData.ts');
